...
# Importación de habilidades y base de datos
from skills import red_interceptor, data_cleaner
from skills import db_manager
...
def inicializar_entorno():
    """Inicializa las tablas y la estructura de reserva."""
...
def ejecutar_pipeline(numero_juicio: str = typer.Argument(..., help="Número de expediente a extraer")):
    ...
    try:
        ...
        if df_crudo.empty:
            console.print("[bold yellow]No se interceptaron datos JSON relevantes.[/bold yellow]")
            return
